...
void Matrix4_invert(Matrix4 *matrix);                               // check best inverse method before inverse
void Matrix4_invertAffine(Matrix4 *matrix);                         // inverse of affine transform matrix
void Matrix4_invertGeneral(Matrix4 *matrix);                        // inverse of generic matrix
// transform matrix
void Matrix4_translate_xyz(Matrix4* matrix, float x, float y, float z);   // translation by (x,y,z)
void Matrix4_translate_v(Matrix4* matrix, const Vector3* v);            //
void Matrix4_scale_s(Matrix4* matrix, float scale);                     // uniform scale
void Matrix4_scale_xyz(Matrix4* matrix, float sx, float sy, float sz);    // scale by (sx, sy, sz) on each axis
// operators
Vector4 Matrix4_multiply_Vector4(const Matrix4* const lhs, const Vector4* const rhs);    // multiplication: v' = M * v
Matrix4 Matrix4_multiply_Matrix4(const Matrix4* const lhs, const Matrix4* const rhs);    // multiplication: M3 = M1 * M2
